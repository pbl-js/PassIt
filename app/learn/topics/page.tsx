...
function SavedWordsWidget() {
  return (
    <>
      <div className={`flex lg:hidden bg-white/5 rounded-2xl ${topSectionsPadding}`}>
        <p className="text-3xl font-semibold text-white">Words List mobile</p>
      </div>
      <div className={`hidden lg:flex  bg-white/5 rounded-2xl ${topSectionsPadding}`}>
  ...
  return (
    <>
      ...
      <div className="flex flex-col w-full">
        ...
        <div className="mb-10">
          <Paragraph className="text-4xl font-semibold mb-6">Moje zestawy</Paragraph>
          <div className="flex flex-wrap flex-row gap-5">
            {topicsList.map(
              ({ title, color }, index) =>
                index > 3 && (
                  <div key={title} style={{ backgroundColor: color }} className="w-[214px] h-[164px] rounded-xl p-4">
                    title
                  </div>
                ),
            )}
        ...
        <div className="mb-10">
          <Paragraph className="text-4xl font-semibold mb-6">Czasowniki nieregularne</Paragraph>
          <div className="flex flex-wrap flex-row gap-5">
        ...
        <div className="mb-10">
          <Paragraph className="text-4xl font-semibold mb-6">Zestawy premium</Paragraph>
          <div className="flex flex-wrap flex-row gap-5">
            {topicsList.map(({ title, color }) => (
              <div key={title} style={{ backgroundColor: color }} className="w-[214px] h-[164px] rounded-xl p-4">
                title
